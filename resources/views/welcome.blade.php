...
<head>
    ...
    <style>
        /* Background gradient animasi bergerak */
        body {
        ...
        <div class="row justify-content-center g-4">
            <div class="col-md-4">
                <a href="{{ url('/siswa/register') }}" class="text-decoration-none">
                    <div class="role-card text-center">
                        <img src="https://cdn-icons-png.flaticon.com/512/201/201818.png" alt="Siswa" class="role-icon">
            ...
            <div class="col-md-4">
                <a href="{{ url('/guru/register') }}" class="text-decoration-none">
                    <div class="role-card text-center">
                        <img src="https://cdn-icons-png.flaticon.com/512/219/219986.png" alt="Guru" class="role-icon">
